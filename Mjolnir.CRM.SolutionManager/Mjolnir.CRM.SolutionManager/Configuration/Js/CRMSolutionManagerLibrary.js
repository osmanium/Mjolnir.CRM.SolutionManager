...
function PatchToSolution(selectedSolutionId) {
    debugger;
    var operation = 'Mjolnir.CRM.SolutionManager.JsOperations.ConvertPatchesToSolutionOperation';
    var inputObj = {
...
function ApplySolutionUpgrade(selectedSolutionId) {
    ...
    var operation = 'Mjolnir.CRM.SolutionManager.JsOperations.ApplySolutionUpgradeOperation';
    var inputObj = {
        SelectedSolutionIds: selectedSolutionId
    }
